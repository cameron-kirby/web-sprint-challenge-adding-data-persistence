...
1. Explain the difference between `Relational Databases` and `SQL`.
    ...
    - Relational Databases use SQL to manipulate data stored inside of them

2. Why do tables need a `primary key`?

    - A Primary Key insures row-level accessibility
...
4. What do we need in order to have a _many to many_ relationship between two tables.
    ...
    - A Junction table will be required to have a many to many relationship between two tables
